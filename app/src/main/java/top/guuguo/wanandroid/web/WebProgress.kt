...
class WebProgress @JvmOverloads constructor(
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        if (mTargetWidth >= screenWidth) {
            ...
            val rate =
                mTargetWidth / java.lang.Float.valueOf(screenWidth.toFloat())
            CURRENT_MAX_UNIFORM_SPEED_DURATION =
    ...
    fun setProgress(progress: Float) { // fix 同时返回两个 100，产生两次进度条的问题；
    ...
    companion object {
         ...
         * 当前匀速动画最大的时长
         */
        private var CURRENT_MAX_UNIFORM_SPEED_DURATION =
            MAX_UNIFORM_SPEED_DURATION
        /**
         * 当前加速后减速动画最大时长
         */
        private var CURRENT_MAX_DECELERATE_SPEED_DURATION =
            MAX_DECELERATE_SPEED_DURATION
        /**
         * 默认的高度(dp)
         */
